  ...
  return (
    <div>
      ...
      <p>
        ...
        and LifeChart, located at 2947 Meadowvista Plc, Coquitlam, British
        Columbia, Canada (we, us), concerning your access to and use of the
        LifeChart (https://www.lifechart.ca) website as well as any related
        applications (the Site).
      </p>

      <p>
        The Site provides the following services: Online web service that
        combines your activity and nutrition data from Google Fit with a custom
        daily health tracker to provide rich, informative data visualizations to
        help you take control over and improve any aspect of your physical or
        mental health. (Services). You agree that by accessing the Site and/or
      ...
      <p>
        1.5 Our site is directed to people residing in Canada. The information
        ...
        or use would be contrary to law or regulation or which would subject us
      ...
      <p>
        Our Privacy Notice https://www.lifechart.ca/privacy, which sets out the
      ...
      <ul>
        ...
        <li>
          ...
          uninterrupted use and enjoyment of the Site, or any material that acts
      ...
      <p>
        ...
        password you must promptly notify us at report@lifechart.ca.
      </p>
      ...
      <p>
        ...
        (each such account, a Third Party Account) by either: (a) providing your
        Third Party Account login information through the Site; or (b) allowing
      ...
      <p>
        ...
        on the Site and your Third Party Accounts at any time. Please note that
      ...
      <p>
        ...
        Site. At your email request to jeff@moger.com or through your account
        settings (if applicable), we will deactivate the connection between the
        Site and your Third Party Account and attempt to delete any information
        stored on our servers that was obtained through such Third Party
        Account, except the username and profile picture that became associated
        with your account.
      </p>
      ...
      <p>
        4.4 You shall not (a) try to gain unauthorized access to the Site or any
      ...
      <p>
        5.1 We reserve the right at our sole discretion, to (1) monitor the Site
      ...
      <p>
        5.2 We do not guarantee that the Site will be secure or free from bugs
        or viruses.
      </p>

      <p>
        5.3 You are responsible for configuring your information technology,
        computer programs and platform to access the Site and you should use
        your own virus protection software.
      </p>

      <h2>6. Modifications to and availability of the Site</h2>

      <p>
        6.1 We reserve the right to change, modify, or remove the contents of
      ...
      <p>
        6.2 We cannot guarantee the Site and Services will be available at all
      ...
      <p>
        6.3 There may be information on the Site that contains typographical
      ...
      <p>
        7.1 The Site and Services are provided on an as-is and as-available
      ...
      <p>7.2 Our responsibility for loss or damage suffered by you:</p>
      ...
      <ul>
        ...
        <li>
          ...
          of (a) the sum of £1000 or (b) the amount paid, if any, by you to us
          for the Services/Site during the six (6) month period prior to any
      ...
      <p>
        8.1 These Terms and Conditions shall remain in full force and effect
      ...
      <p>
        8.2 Without limiting any other provision of these Terms and Conditions,
      ...
      <p>
        8.3 If we terminate or suspend your account for any reason set out in
      ...
      <p>
        9.2 These Terms and Conditions and any policies or operating rules
      ...
      <p>
        9.3 Our failure to exercise or enforce any right or provision of these
        Terms and Conditions shall not operate as a waiver of such right or
        provision.
      </p>

      <p>
        9.4 We may assign any or all of our rights and obligations to others at
        any time.
      </p>

      <p>
        9.5 We shall not be responsible or liable for any loss, damage, delay or
        failure to act caused by any cause beyond our reasonable control.
      </p>

      <p>
        9.6 If any provision or part of a provision of these Terms and
      ...
      <p>
        9.7 There is no joint venture, partnership, employment or agency
        relationship created between you and us as a result of these Terms and
        Conditions or use of the Site or Services.
      </p>

      <p>
        9.8 For consumers only - Please note that these Terms and Conditions,
      ...
      <p>
        9.9 A person who is not a party to these Terms and Conditions shall have
        no right under the Contracts (Rights of Third Parties) Act 1999 to
        enforce any term of these Terms and Conditions.
      </p>

      <p>
        9.10 In order to resolve a complaint regarding the Services or to
        receive further information regarding use of the Services, please
        contact us by email at complaint@lifechart.ca or by post to:
      </p>

      <p>
        LifeChart
        <br />
        2947 Meadowvista Plc
        <br />
