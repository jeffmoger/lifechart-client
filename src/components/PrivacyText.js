...
export default function PrivacyText() {
  return (
    <div>
      ...
      <p>
        Thank you for choosing to be part of our community at LifeChart
      ...
      <p>
        When you visit our website https://www.lifechart.ca (the "Website"), and
      ...
      <ul>
        <li>
          ...
          names; google fit physical activity data and nutrition; and other
          similar information.
        </li>
      ...
      <ul>
        ...
        <li>
          ...
          contact us at dpo@lifechart.ca and be sure to include your name,
      ...
      <p>
        ...
        email us at privacy@lifechart.com.
      </p>
      ...
      <p>
        ...
        purposes. To otherwise opt-out, you may access your account settings and
      ...
      <p>
        ...
        dpo@lifechart.ca or by post to:
      </p>
      ...
      <p>
        ...
        that information, or delete it in some circumstances. Email or write to
        the address above and we will respond to your request within 30 days.
      </p>
    </div>
  );
}
